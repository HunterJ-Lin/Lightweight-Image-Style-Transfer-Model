...
if __name__ == '__main__':
    ...
    parser.add_argument("--model_name", type=str, default="TransformerNet_Small", help="TransformerNet Type")
    ...
    transformerNet = recontruction.__dict__[args.model_name](7).to(device)
